...
### Logic Questions
- What happens with null inputs? Is Optional used where appropriate?
...
| Review Focus | Time % |
|--------------|--------|
| Context and PR description | 10% |
| Architecture and design | 20% |
| Code logic and details | 40% |
| Tests and coverage | 20% |
| Final review and summary | 10% |
